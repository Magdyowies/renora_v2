...
export const paymentAPI = {
  ...
  validatePromoCode: (code, amount) => api.post('/payments/promo-codes/validate/', { code, booking_amount: amount }),
};
...
export const chatAPI = {
  ...
  sendMessage: (id, content) => api.post(`/chat/sessions/${id}/send/`, { content }),
